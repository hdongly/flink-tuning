package com.apple.flink.source.bean;

import com.apple.flink.source.config.AppConfig;
import com.apple.flink.source.enums.DisplayType;
import com.apple.flink.source.enums.ItemType;
import com.apple.flink.source.enums.PageId;
import com.apple.flink.source.util.ParamUtil;
import com.apple.flink.source.util.RandomNum;
import com.apple.flink.source.util.RandomOptionGroup;
...
import static com.apple.flink.source.config.AppConfig.*;
